...
# # def clean_text(text: str) -> str:
# #     """Enhanced text cleaning for better standard preservation"""
# #     # Preserve standard numbers and references
# #     text = re.sub(r'SLFRS\s+(\d+)', r'SLFRS\1', text)
# #     text = re.sub(r'LKAS\s+(\d+)', r'LKAS\1', text)
    
# #     # Preserve section headers
# #     text = re.sub(r'\n([A-Z][A-Za-z\s]+)(?=\n)', r'\n### \1', text)
    
# #     # Clean while preserving important characters
# #     text = re.sub(r'[^\w\s.,;:?!()\[\]{}\-–—•\n\*]', ' ', text)
...
#     """Extract text with enhanced educational content structure"""
#     documents = []
...
#             "number": standard_match.group(2) if standard_match else None
#         }
...
# def main():
#     pdf_dir = "pdf"
#     collection_name = "acca_collection"
